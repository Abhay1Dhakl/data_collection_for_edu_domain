...
var content = [
    // slide0
    {
        ...
        imageblock:[{
            imagestoshow:[
                {
                    imgdiv:"imagegeneraldiv bgForPigDiv",
                    imgclass: "generalchild bgForPig",
                    imgid : 'pinImg',
                    imgsrc: "",
                    audioicon:true
                },
    ...
    //slide 1
    {
        ...
        imageblock:[{
            imagestoshow:[
                {
                    imgdiv:"imagegeneraldiv bgForBinDiv",
                    imgclass: "generalchild bgForBin",
                    imgid : 'binImg',
                    imgsrc: "",
                    audioicon:true
                },
  ...
  var $refreshBtn= $("#activity-page-refresh-btn");
    ...
    function init() {
        ...
        manifest = [
            ...
            // // images
            {id: "pinImg", src: imgpath+"safetypin.png", type: createjs.AbstractLoader.IMAGE},
            ...
            {id: "sound_0", src: soundAsset+"PIN.mp3"},
            {id: "sound_1", src: soundAsset+"p3_s0_0.mp3"},
            {id: "sound_2", src: soundAsset+"p3_s0_1.mp3"},
            {id: "sound_3", src: soundAsset+"p3_s0_2.mp3"},
            {id: "sound_4", src: soundAsset+"p3_s1_0.mp3"},
            {id: "sound_5", src: soundAsset+"p3_s1_1.mp3"},
            {id: "sound_6", src: soundAsset+"p3_s1_2.mp3"},
            {id: "sound_7", src: soundAsset+"BIN.mp3"},
        ];
    ...
    function generaltemplate() {
     ...
     $('.imagegeneraldiv > img, .audioicon1').click(function(){
      ...
      $('alphadiv1 > p, .audioicon4').click(function(){
