...
var content = [
    //slide 0
    {
        ...
        imageblock:[{
            imagestoshow:[
                {
                    imgdiv:"imagegeneraldiv bgForMugDiv",
                    imgclass: "generalchild bgForMug",
                    imgid : 'mugImg',
                    imgsrc: "",
                    audioicon:true
                },
    ...
    //slide 1
    {
        ...
        imageblock:[{
            imagestoshow:[
                {
                    imgdiv:"imagegeneraldiv bgForJugDiv",
                    imgclass: "generalchild bgForJug",
                    imgid : 'jugImg',
                    imgsrc: "",
                    audioicon:true
                },
  ...
  var $refreshBtn= $("#activity-page-refresh-btn");
    ...
    function init() {
        ...
        manifest = [
            ...
            // // images
            {id: "mugImg", src: imgpath+"mug.png", type: createjs.AbstractLoader.IMAGE},
            ...
            // sounds
             {id: "sound_0", src: soundAsset+"MUG.mp3"},
             {id: "sound_1", src: soundAsset+"p5_s1_0.mp3"},
             {id: "sound_2", src: soundAsset+"p5_s1_1.mp3"},
             {id: "sound_3", src: soundAsset+"p5_s1_2.mp3"},
             {id: "sound_4", src: soundAsset+"p5_s0_0.mp3"},
             {id: "sound_5", src: soundAsset+"p5_s0_1.mp3"},
             {id: "sound_6", src: soundAsset+"p5_s0_2.mp3"},
             {id: "sound_7", src: soundAsset+"JUG.mp3"},
