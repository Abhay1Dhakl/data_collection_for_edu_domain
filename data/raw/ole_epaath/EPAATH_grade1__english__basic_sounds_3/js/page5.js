	...
	function generalTemplate() {
		...
		switch (countNext) {
			...
			case 1:
				...
				setTimeout(function () {
					$('.egg_4').attr('src', imgpath + "eggs/egg05b.png");
