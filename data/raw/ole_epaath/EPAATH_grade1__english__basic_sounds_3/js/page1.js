...
var soundAsset = $ref + "/sounds/1/";

var coversound = new buzz.sound((soundAsset + "BS_title_3.mp3"));
var sound_0 = new buzz.sound((soundAsset + "0.mp3"));
...
var sound_group = [sound_0, sound_1, sound_2, sound_3, sound_4];
		...
		imageblock: [{
			...
			imagelabels: [
				...
				},
				{
					...
					imagelabeldata: data.string.p5text1
				},
				{
				...
				{
					imagelabelclass: "egg_label_7 egg_label",
			...
			case 3:
				...
				$('.card_deck').on("click", function () {
					...
					if (c.contains("card_deck")) {
						...
						var dh = 25 + ((card_count % 2)) * 50;			// calculates left position according to card number
