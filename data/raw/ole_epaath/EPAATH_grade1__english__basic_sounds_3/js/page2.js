	...
	function generalTemplate() {
		...
		switch (countNext) {
			...
			case 1:
				...
				setTimeout(function () {
					$('.egg_1').attr('src', imgpath + "eggs/egg01b.png");
