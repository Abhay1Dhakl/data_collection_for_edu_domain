...
//slide0
{
	...
	imageblock : [{
		...
		{
			imgclass : "egg egg_7 vertical_vibration",
		...
		{
			imagelabelclass : "egg_label_7 egg_label font_vibration",
			...
			cardstoshow : [
				{
					...
					frontimgsrc : imgpath + "flipcard03.png",
					backimgclass : "card_front",
					backimgsrc : imgpath + "8/4.png",
					imagelabelclass : "",
					imagelabeldata : data.string.p8text5,
				}
		]},
		{
			cardstoshow : [
				{
					...
					frontimgsrc : imgpath + "flipcard03.png",
					backimgclass : "card_front",
					backimgsrc : imgpath + "8/5.png",
					imagelabelclass : "",
					imagelabeldata : data.string.p8text6,
				}
		]},
		{
			cardstoshow : [
				{
					...
					frontimgsrc : imgpath + "flipcard03.png",
					backimgclass : "card_front",
					backimgsrc : imgpath + "8/6.png",
					imagelabelclass : "",
					imagelabeldata : data.string.p8text7,
				}
		]}
...
var $nextBtn = $("#activity-page-next-btn-enabled");
	...
	function generalTemplate() {
		...
		case 1:
			...
			setTimeout(function() {
    			$('.egg_7').attr('src', imgpath + "eggs/egg05b.png");
    			$('.egg_7').removeClass('vertical_vibration');
    			$('.egg').addClass('fade_out');
    			$('.egg_label_7').removeClass('font_vibration');
