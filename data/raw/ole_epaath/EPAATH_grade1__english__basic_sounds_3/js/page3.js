				...
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "3/2.png",
						imagelabelclass: "",
						imagelabeldata: data.string.p3text3,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "3/3.png",
						imagelabelclass: "",
						imagelabeldata: data.string.p3text4,
					}
				]
			},
			{
