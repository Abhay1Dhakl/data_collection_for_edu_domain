  ...
  var $refreshBtn= $("#activity-page-refresh-btn");
	...
	function init() {
		...
		manifest = [
			...
			{id: "bin", src: imgpath+"bin.png", type: createjs.AbstractLoader.IMAGE},
			{id: "pig", src: imgpath+"pig.png", type: createjs.AbstractLoader.IMAGE},
			{id: "six", src: imgpath+"six.png", type: createjs.AbstractLoader.IMAGE},
			//textboxes
			{id: "tb-2", src: 'images/textbox/white/tl-1.png', type: createjs.AbstractLoader.IMAGE},
			{id: "tb-1", src: 'images/textbox/white/lb-1.png', type: createjs.AbstractLoader.IMAGE},
			// sounds
			{id: "sound_i", src: soundAsset+"i.mp3"},
			{id: "sound_in", src: soundAsset+"in.mp3"},
			{id: "sound_pin", src: soundAsset+"pin.mp3"},
			{id: "sound_bin", src: soundAsset+"bin.mp3"},
			{id: "sound_ig", src: soundAsset+"ig.mp3"},
			{id: "sound_pig", src: soundAsset+"pig.mp3"},
			{id: "sound_ix", src: soundAsset+"ix.mp3"},
			{id: "sound_six", src: soundAsset+"six.mp3"},
		];
	...
	function generaltemplate() {
		...
		switch(countNext) {
			case 0:
				...
				$('.text_1').fadeIn(500);
				sound_player('sound_i','.text_1');
				$('.text_2').delay(1000).fadeIn(500);
				setTimeout(function(){
					sound_player('sound_in','.text_2');
				},1000);
				$('.text_3').delay(2000).fadeIn(500);
				setTimeout(function(){
					sound_player('sound_pin','.text_3');
				},2000);
			...
			case 2:
				...
				$('.text_2').delay(1000).fadeIn(500);
				setTimeout(function(){
					sound_player('sound_ig','.text_2');
				},1000);
				$('.text_3').delay(2000).fadeIn(500);
				setTimeout(function(){
					sound_player('sound_pig','.text_3');
				},2000);
				nav_button_controls(4000);
				break;
			case 3:
				...
				$('.text_2').delay(1000).fadeIn(500);
				setTimeout(function(){
					sound_player('sound_ix','.text_2');
				},1000);
				$('.text_3').delay(2000).fadeIn(500);
				setTimeout(function(){
					sound_player('sound_six','.text_3');
				},2000);
				nav_button_controls(4000);
				break;
		}
