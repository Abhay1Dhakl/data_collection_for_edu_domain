...
var content=[
	...
	// slide3_sec
	{
		...
		cloudpage: [{
			...
			cloudtextblock:[
				{
					cloudtextdiv: ' cld-1 pronunce-effect',
					imgclass : "",
					imgsrc : '',
					imgid : 'cloud',
					textclass : "text-a",
					...
					cloudtextdiv: ' cld-2 pronunce-effect',
					imgclass : "",
					imgsrc : '',
					imgid : 'cloud',
					textclass : "text-b",
					...
					cloudtextdiv: ' cld-3 pronunce-effect',
					imgclass : "",
					imgsrc : '',
					imgid : 'cloud',
					textclass : "text-c",
					...
					cloudtextdiv: 'cld-4 pronunce-effect',
					imgclass : "",
					imgsrc : '',
					imgid : 'cloud',
					textclass : "text-d",
					...
					cloudtextdiv: 'cld-5 pronunce-effect',
					imgclass : "",
					imgsrc : '',
					imgid : 'cloud',
					textclass : "text-e",
					...
					cloudtextdiv: 'cld-6 pronunce-effect',
					imgclass : "",
					imgsrc : '',
					imgid : 'cloud',
					textclass : "text-f",
					...
					cloudtextdiv: 'cld-7 pronunce-effect',
					imgclass : "",
					imgsrc : '',
					imgid : 'cloud',
					textclass : "text-g",
					...
					cloudtextdiv: 'cld-8 pronunce-effect',
					imgclass : "",
					imgsrc : '',
					imgid : 'cloud',
					textclass : "text-h",
  ...
  var $refreshBtn= $("#activity-page-refresh-btn");
	...
	function init() {
		...
		manifest = [
			...
			{id: "sound_5", src: soundAsset+"p1_s4.mp3"},
			{id: "sound_6", src: soundAsset+"s1_p5.mp3"},
