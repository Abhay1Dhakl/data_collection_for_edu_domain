...
var sound_calf = new buzz.sound((soundAsset + "cup.mp3"));
var sound_camel = new buzz.sound((soundAsset + "comb.mp3"));
var sound_candle = new buzz.sound((soundAsset + "cat.mp3"));
var sound_cat = new buzz.sound((soundAsset + "doctor.mp3"));
var sound_comb = new buzz.sound((soundAsset + "photocopy.mp3"));
var sound_computer = new buzz.sound((soundAsset + "staircase.mp3"));

var sound_group_c = [sound_c, sound_calf, sound_camel, sound_candle, sound_cat, sound_comb, sound_computer];
	...
	//slide0
	{
		...
		imageblock: [{
			imagestoshow: [
				...
				{
					imgclass: "egg egg_1 vertical_vibration",
			...
			imagelabels: [
				...
				{
					imagelabelclass: "egg_label_1 egg_label font_vibration",
	...
	//slide1
	{
		...
		imageblock: [{
			imagestoshow: [
				...
				{
					imgclass: "egg egg_1 vertical_vibration",
					imgsrc: imgpath + "eggs/egg04a.png",
				},
				{
					imgclass: "egg egg_2",
					imgsrc: imgpath + "eggs/egg05.png",
				...
				cardstoshow: [
					{
						...
						backimgsrc: imgpath + "c/cup.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pctext2,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "c/comb.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pctext3,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "c/cat.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pctext4,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "c/doctor.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pctext5,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "c/photocopy.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pctext6,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "c/staircase.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pctext7,
					}
				]
			}
	...
	function generalTemplate() {
		...
		switch (countNext) {
			...
			case 1:
				...
				setTimeout(function () {
					$('.egg_1').attr('src', imgpath + "eggs/egg04b.png");
					$('.egg_1').removeClass('vertical_vibration');
					$('.egg').addClass('fade_out');
					$('.egg_label_1').removeClass('font_vibration');
