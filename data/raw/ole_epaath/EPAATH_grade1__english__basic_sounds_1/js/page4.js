...
var sound_0 = new buzz.sound((soundAsset + "f.mp3"));
var sound_1 = new buzz.sound((soundAsset + "frog.mp3"));
var sound_2 = new buzz.sound((soundAsset + "flower.mp3"));
var sound_3 = new buzz.sound((soundAsset + "fish.mp3"));
var sound_4 = new buzz.sound((soundAsset + "butterfly.mp3"));
var sound_5 = new buzz.sound((soundAsset + "calf.mp3"));
var sound_6 = new buzz.sound((soundAsset + "knife.mp3"));
	...
	//slide0
	{
		...
		imageblock: [{
			imagestoshow: [
				...
				{
					imgclass: "egg egg_3 vertical_vibration",
			...
			imagelabels: [
				...
				{
					imagelabelclass: "egg_label_3 egg_label font_vibration",
	...
	//slide1
	{
		...
		imageblock: [{
			imagestoshow: [
				...
				{
					imgclass: "egg egg_3 vertical_vibration",
					imgsrc: imgpath + "eggs/egg08a.png",
				},
				{
					imgclass: "egg egg_4",
					imgsrc: imgpath + "eggs/egg02.png",
				...
				cardstoshow: [
					{
						...
						backimgsrc: imgpath + "f/frog.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pftext2,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "f/flower.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pftext3,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "f/fish.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pftext4,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "f/butterfly.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pftext5,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "f/calf.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pftext6,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "f/knife.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pftext7,
					}
				]
			}
	...
	function generalTemplate() {
		...
		switch (countNext) {
			...
			case 1:
				...
				setTimeout(function () {
					$('.egg_3').attr('src', imgpath + "eggs/egg08b.png");
					$('.egg_3').removeClass('vertical_vibration');
					$('.egg').addClass('fade_out');
					$('.egg_label_3').removeClass('font_vibration');
