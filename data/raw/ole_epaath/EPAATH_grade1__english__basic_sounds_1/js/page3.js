...
var sound_0 = new buzz.sound((soundAsset + "d.mp3"));
var sound_1 = new buzz.sound((soundAsset + "door.mp3"));
var sound_2 = new buzz.sound((soundAsset + "duck.mp3"));
var sound_3 = new buzz.sound((soundAsset + "deer.mp3"));
var sound_4 = new buzz.sound((soundAsset + "slide.mp3"));
var sound_5 = new buzz.sound((soundAsset + "bed.mp3"));
var sound_6 = new buzz.sound((soundAsset + "video.mp3"));
	...
	//slide0
	{
		...
		imageblock: [{
			imagestoshow: [
				...
				{
					imgclass: "egg egg_2 vertical_vibration",
			...
			imagelabels: [
				...
				{
					imagelabelclass: "egg_label_2 egg_label font_vibration",
	...
	//slide1
	{
		...
		imageblock: [{
			imagestoshow: [
				...
				{
					imgclass: "egg egg_2 vertical_vibration",
					imgsrc: imgpath + "eggs/egg05a.png",
				},
				{
					imgclass: "egg egg_3",
					imgsrc: imgpath + "eggs/egg08.png",
				...
				cardstoshow: [
					{
						...
						backimgsrc: imgpath + "d/door.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pdtext2,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "d/duck.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pdtext3,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "d/deer.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pdtext4,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "d/slide.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pdtext5,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "d/bed.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pdtext6,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "d/video.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pdtext7,
					}
				]
			}
	...
	function generalTemplate() {
		...
		switch (countNext) {
			...
			case 1:
				...
				setTimeout(function () {
					$('.egg_2').attr('src', imgpath + "eggs/egg05b.png");
					$('.egg_2').removeClass('vertical_vibration');
					$('.egg').addClass('fade_out');
					$('.egg_label_2').removeClass('font_vibration');
