...
var sound_0 = new buzz.sound((soundAsset + "j.mp3"));
var sound_1 = new buzz.sound((soundAsset + "jug.mp3"));
var sound_2 = new buzz.sound((soundAsset + "juice.mp3"));
var sound_3 = new buzz.sound((soundAsset + "jar.mp3"));
var sound_4 = new buzz.sound((soundAsset + "joker.mp3"));
var sound_5 = new buzz.sound((soundAsset + "jet.mp3"));
var sound_6 = new buzz.sound((soundAsset + "jam.mp3"));
	...
	//slide0
	{
		...
		imageblock: [{
			imagestoshow: [
				...
				{
					imgclass: "egg egg_6 vertical_vibration",
			...
			imagelabels: [
				...
				{
					imagelabelclass: "egg_label_6 egg_label font_vibration",
	...
	//slide1
	{
		...
		imageblock: [{
			imagestoshow: [
				...
				{
					imgclass: "egg egg_6 vertical_vibration",
					imgsrc: imgpath + "eggs/egg07a.png",
				},
				{
					imgclass: "sound_waves_0 sound_vibration",
					imgsrc: imgpath + "eggs/wave.png",
				...
				cardstoshow: [
					{
						...
						backimgsrc: imgpath + "j/jug.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pjtext2,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "j/juice.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pjtext3,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "j/jar.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pjtext4,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "j/joker.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pjtext5,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "j/jet.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pjtext6,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "j/jam.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pjtext7,
					}
				]
			}
	...
	function generalTemplate() {
		...
		switch (countNext) {
			...
			case 1:
				...
				setTimeout(function () {
					$('.egg_6').attr('src', imgpath + "eggs/egg07b.png");
					$('.egg_6').removeClass('vertical_vibration');
					$('.egg').addClass('fade_out');
					$('.egg_label_6').removeClass('font_vibration');
