...
var sound_0 = new buzz.sound((soundAsset + "g.mp3"));
var sound_1 = new buzz.sound((soundAsset + "gate.mp3"));
var sound_2 = new buzz.sound((soundAsset + "goat.mp3"));
var sound_3 = new buzz.sound((soundAsset + "garland.mp3"));
var sound_4 = new buzz.sound((soundAsset + "pig.mp3"));
var sound_5 = new buzz.sound((soundAsset + "bag.mp3"));
var sound_6 = new buzz.sound((soundAsset + "tiger.mp3"));
	...
	//slide0
	{
		...
		imageblock: [{
			imagestoshow: [
				...
				{
					imgclass: "egg egg_4 vertical_vibration",
			...
			imagelabels: [
				...
				{
					imagelabelclass: "egg_label_4 egg_label font_vibration",
	...
	//slide1
	{
		...
		imageblock: [{
			imagestoshow: [
				...
				{
					imgclass: "egg egg_4 vertical_vibration",
					imgsrc: imgpath + "eggs/egg02a.png",
				},
				{
					imgclass: "egg egg_5",
					imgsrc: imgpath + "eggs/egg06.png",
				...
				cardstoshow: [
					{
						...
						backimgsrc: imgpath + "g/gate.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pgtext2,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "g/goat.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pgtext3,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "g/garland.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pgtext4,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "g/pig.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pgtext5,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "g/bag.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pgtext6,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "g/tiger.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pgtext7,
					}
				]
			}
	...
	function generalTemplate() {
		...
		switch (countNext) {
			...
			case 1:
				...
				setTimeout(function () {
					$('.egg_4').attr('src', imgpath + "eggs/egg02b.png");
					$('.egg_4').removeClass('vertical_vibration');
					$('.egg').addClass('fade_out');
					$('.egg_label_4').removeClass('font_vibration');
