...
var coversound = new buzz.sound((soundAsset + "BS_title_1.mp3"));
var sound_b = new buzz.sound((soundAsset + "b.mp3"));
var sound_bag = new buzz.sound((soundAsset + "book.mp3"));
var sound_ball = new buzz.sound((soundAsset + "ball.mp3"));
var sound_bed = new buzz.sound((soundAsset + "bee.mp3"));
var sound_butterfly = new buzz.sound((soundAsset + "football.mp3"));
var sound_book = new buzz.sound((soundAsset + "dustbin.mp3"));
var sound_bee = new buzz.sound((soundAsset + "table.mp3"));

var sound_group_b = [sound_b, sound_bag, sound_ball, sound_bed, sound_butterfly, sound_book, sound_bee];
...
var content = [
	...
	//slide0
	{
		contentblockadditionalclass: 'frontbg',
		...
		imageblock: [{
			imagestoshow: [
				{
					imgclass: "duck",
					imgsrc: imgpath + "ducking.gif",
				},
				{
					imgclass: "rhino",
					imgsrc: imgpath + "rhino.gif",
				},
				{
					imgclass: "b_css",
					imgsrc: imgpath + "b.gif",
				},
				{
					imgclass: "c_css",
					imgsrc: imgpath + "c.gif",
				},
				{
					imgclass: "d_css",
					imgsrc: imgpath + "d.gif",
				},
				{
					imgclass: "j_css",
					imgsrc: imgpath + "j.gif",
				}]
		}],
	},
	...
	//slide1
	{
		...
		imageblock: [{
			imagestoshow: [
				{
					imgclass: "egg egg_0 vertical_vibration",
			...
			imagelabels: [
				{
					imagelabelclass: "egg_label_0 egg_label  font_vibration",
				...
				{
					imagelabelclass: "egg_label_5 egg_label",
	...
	//slide2
	{
		...
		imageblock: [{
			imagestoshow: [
				{
					imgclass: "egg egg_0 vertical_vibration",
					imgsrc: imgpath + "eggs/egg01a.png",
				},
				{
					imgclass: "egg egg_1",
					imgsrc: imgpath + "eggs/egg04.png",
				...
				cardstoshow: [
					{
						...
						backimgsrc: imgpath + "b/book.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pbtext2,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "b/ball.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pbtext3,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "b/bee.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pbtext4,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "b/football.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pbtext5,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "b/dustbin.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pbtext6,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "b/table.png",
						imagelabelclass: "",
						imagelabeldata: data.string.pbtext7,
					}
				]
			}
...
$(function () {
	...
	function navigationController(islastpageflag) {
		...
		} else if (countNext == 3 || countNext == 4 || countNext == 5) {
			$nextBtn.hide(0);
			$prevBtn.show(0);
	...
	function generalTemplate() {
		...
		$('.frontbg').css('background-image', 'url(' + imgpath + '/basic_sound.jpg)');
		$('.main_bg').css('background-image', 'url(' + imgpath + '/main_bg.jpg)');
		switch (countNext) {
			case 0:
				coversound.play();
				setTimeout(function () {
			...
			case 2:
				...
				setTimeout(function () {
					$('.egg_0').attr('src', imgpath + "eggs/egg01b.png");
					$('.egg_0').removeClass('vertical_vibration');
					$('.egg').addClass('fade_out');
					$('.egg_label_0').removeClass('font_vibration');
