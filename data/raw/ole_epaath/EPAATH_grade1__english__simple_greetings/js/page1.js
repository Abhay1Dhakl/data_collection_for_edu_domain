  ...
  var $refreshBtn= $("#activity-page-refresh-btn");
	...
	function init() {
		...
		manifest = [
			...
			{id: "p02", src: imgpath+"p02.png", type: createjs.AbstractLoader.IMAGE},
			{id: "p03", src: imgpath+"p03.png", type: createjs.AbstractLoader.IMAGE},
			{id: "p04", src: imgpath+"p04.png", type: createjs.AbstractLoader.IMAGE},
			{id: "p05", src: imgpath+"p05.png", type: createjs.AbstractLoader.IMAGE},
			{id: "p06", src: imgpath+"p06.png", type: createjs.AbstractLoader.IMAGE},
			...
			{id: "sound_3", src: soundAsset+"s1_p3.mp3"},
			{id: "sound_4", src: soundAsset+"S1_P4.mp3"},
			{id: "sound_5", src: soundAsset+"S1_P5.mp3"},
			{id: "sound_6", src: soundAsset+"s1_p6.mp3"},
			{id: "sound_7", src: soundAsset+"S1_P7.mp3"},
			{id: "sound_8", src: soundAsset+"S1_P8.mp3"},
		];
