				...
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "7/4.png",
						imagelabelclass: "",
						imagelabeldata: data.string.p7text5,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "7/5.png",
						imagelabelclass: "",
						imagelabeldata: data.string.p7text6,
					}
				]
			},
			{
				cardstoshow: [
					{
						...
						frontimgsrc: imgpath + "flipcard03.png",
						backimgclass: "card_front",
						backimgsrc: imgpath + "7/6.png",
						imagelabelclass: "",
						imagelabeldata: data.string.p7text7,
					}
				]
			}
	...
	function generalTemplate() {
		...
		switch (countNext) {
			...
			case 1:
				...
				setTimeout(function () {
					$('.egg_6').attr('src', imgpath + "eggs/egg05b.png");
